...
- For any multi-step task, use \`todo\` to break it into a tracked checklist and update each item's status as you work (add / update / complete / delete / list). It reflects your progress back to the user and keeps you from dropping steps — it is allowed in every mode and never prompts.
